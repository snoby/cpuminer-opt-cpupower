...
am__cpuminer_SOURCES_DIST = cpu-miner.c util.c uint256.cpp api.c \
	...
	crypto/c_blake256.c crypto/c_skein.c crypto/hash.c \
	crypto/aesb.c crypto/magimath.cpp \
	algo/argon2/argon2a/argon2a.c algo/argon2/argon2a/ar2/argon2.c \
	algo/argon2/argon2a/ar2/opt.c algo/argon2/argon2a/ar2/cores.c \
	...
	algo/fugue/sph_fugue.c algo/hamsi/sph_hamsi.c \
	...
	algo/m7m.c algo/neoscrypt/neoscrypt.c algo/pluck.c \
	...
	algo/yescrypt/yescrypt-best.c algo/neuromorph/nm_params.c \
	algo/neuromorph/nm_fast.c algo/neuromorph/neuromorph.c \
...
am_cpuminer_OBJECTS = cpuminer-cpu-miner.$(OBJEXT) \
	...
	algo/argon2/argon2d/argon2d/cpuminer-thread.$(OBJEXT) \
	algo/argon2/argon2d/argon2d/cpuminer-encoding.$(OBJEXT) \
	algo/blake/cpuminer-sph_blake.$(OBJEXT) \
	algo/blake/cpuminer-blake-hash-4way.$(OBJEXT) \
	...
	algo/bmw/cpuminer-bmw-hash-4way.$(OBJEXT) \
	...
	algo/cpuminer-m7m.$(OBJEXT) \
	algo/neoscrypt/cpuminer-neoscrypt.$(OBJEXT) \
	algo/cpuminer-pluck.$(OBJEXT) \
	...
	algo/sha/cpuminer-sha2-hash-4way.$(OBJEXT) \
	...
	algo/skein/cpuminer-skein2-gate.$(OBJEXT) \
	...
	algo/whirlpool/cpuminer-whirlpool-4way.$(OBJEXT) \
	...
	algo/neuromorph/cpuminer-nm_params.$(OBJEXT) \
	algo/neuromorph/cpuminer-nm_fast.$(OBJEXT) \
	algo/neuromorph/cpuminer-neuromorph.$(OBJEXT) $(am__objects_1) \
...
am__depfiles_remade = ./$(DEPDIR)/cpuminer-algo-gate-api.Po \
	...
	algo/argon2/argon2d/argon2d/$(DEPDIR)/cpuminer-thread.Po \
	...
	algo/blake/$(DEPDIR)/cpuminer-blake-hash-4way.Po \
	...
	algo/keccak/sse2/$(DEPDIR)/cpuminer-keccak.Po \
	algo/luffa/$(DEPDIR)/cpuminer-luffa-hash-2way.Po \
	algo/luffa/$(DEPDIR)/cpuminer-luffa.Po \
	algo/luffa/$(DEPDIR)/cpuminer-luffa_for_sse2.Po \
	algo/luffa/$(DEPDIR)/cpuminer-sph_luffa.Po \
	algo/neoscrypt/$(DEPDIR)/cpuminer-neoscrypt.Po \
	algo/neuromorph/$(DEPDIR)/cpuminer-neuromorph.Po \
	algo/neuromorph/$(DEPDIR)/cpuminer-nm_fast.Po \
	algo/neuromorph/$(DEPDIR)/cpuminer-nm_params.Po \
	...
	algo/scryptjane/$(DEPDIR)/cpuminer-scrypt-jane.Po \
	algo/sha/$(DEPDIR)/cpuminer-sha2-hash-4way.Po \
	...
	algo/skein/$(DEPDIR)/cpuminer-skein2-gate.Po \
	...
	algo/whirlpool/$(DEPDIR)/cpuminer-whirlpool-4way.Po \
	...
	algo/yescrypt/$(DEPDIR)/cpuminer-sha256_Y.Po \
	algo/yescrypt/$(DEPDIR)/cpuminer-yescrypt-best.Po \
	algo/yescrypt/$(DEPDIR)/cpuminer-yescrypt.Po \
	algo/yespower/$(DEPDIR)/cpuminer-sha256-P.Po \
	algo/yespower/$(DEPDIR)/cpuminer-yespower-opt.Po \
	algo/yespower/$(DEPDIR)/cpuminer-yespower.Po \
	algo/yespower2b/$(DEPDIR)/cpuminer-yespower-miner.Po \
	algo/yespower2b/$(DEPDIR)/cpuminer-yespower.Po \
	algo/yespower2b/crypto/$(DEPDIR)/cpuminer-blake2b.Po \
	...
	crypto/$(DEPDIR)/cpuminer-magimath.Po \
...
ACLOCAL = ${SHELL} '/home/snoby/miner/cpuminer-opt-cpupower/missing' aclocal-1.16
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/snoby/miner/cpuminer-opt-cpupower/missing' autoconf
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} '/home/snoby/miner/cpuminer-opt-cpupower/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = cpuminer-opt
PACKAGE_BUGREPORT = 
PACKAGE_NAME = cpuminer-opt
PACKAGE_STRING = cpuminer-opt 3.8.8.5-cpu-pool
PACKAGE_TARNAME = cpuminer-opt
PACKAGE_URL = 
PACKAGE_VERSION = 3.8.8.5-cpu-pool
PATH_SEPARATOR = :
PTHREAD_FLAGS = 
...
SHELL = /bin/bash
STRIP = 
VERSION = 3.8.8.5-cpu-pool
WS2_LIBS = 
abs_builddir = /home/snoby/miner/cpuminer-opt-cpupower
...
install_sh = ${SHELL} /home/snoby/miner/cpuminer-opt-cpupower/install-sh
...
# checks in the VM's float path) -- these must never be built with
# -ffast-math/-ffinite-math-only (see the caution comment atop nm_fast.c).
# This override only wins if the global CFLAGS (e.g. from build.sh) doesn't
# also pass -ffast-math after it; do not build this fork's -ffast-math
# profile (build.sh) when mining neuromorph.
algo_neuromorph_nm_fast_CFLAGS = $(cpuminer_CFLAGS) -fno-fast-math -fno-finite-math-only
algo_neuromorph_neuromorph_CFLAGS = $(cpuminer_CFLAGS) -fno-fast-math -fno-finite-math-only
...
algo/bmw/cpuminer-sph_bmw.$(OBJEXT): algo/bmw/$(am__dirstamp) \
	algo/bmw/$(DEPDIR)/$(am__dirstamp)
algo/bmw/cpuminer-bmw-hash-4way.$(OBJEXT): algo/bmw/$(am__dirstamp) \
	algo/bmw/$(DEPDIR)/$(am__dirstamp)
...
algo/sha/cpuminer-sph_sha2big.$(OBJEXT): algo/sha/$(am__dirstamp) \
	algo/sha/$(DEPDIR)/$(am__dirstamp)
algo/sha/cpuminer-sha2-hash-4way.$(OBJEXT): algo/sha/$(am__dirstamp) \
	algo/sha/$(DEPDIR)/$(am__dirstamp)
...
algo/skein/cpuminer-skein2-4way.$(OBJEXT): algo/skein/$(am__dirstamp) \
	algo/skein/$(DEPDIR)/$(am__dirstamp)
algo/skein/cpuminer-skein2-gate.$(OBJEXT): algo/skein/$(am__dirstamp) \
	algo/skein/$(DEPDIR)/$(am__dirstamp)
...
algo/yespower2b/$(am__dirstamp):
	...
	@: > algo/yespower2b/$(am__dirstamp)
algo/yespower2b/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) algo/yespower2b/$(DEPDIR)
	@: > algo/yespower2b/$(DEPDIR)/$(am__dirstamp)
algo/yespower2b/cpuminer-yespower-miner.$(OBJEXT):  \
	algo/yespower2b/$(am__dirstamp) \
	algo/yespower2b/$(DEPDIR)/$(am__dirstamp)
algo/yespower2b/crypto/$(am__dirstamp):
	@$(MKDIR_P) algo/yespower2b/crypto
	@: > algo/yespower2b/crypto/$(am__dirstamp)
algo/yespower2b/crypto/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) algo/yespower2b/crypto/$(DEPDIR)
	@: > algo/yespower2b/crypto/$(DEPDIR)/$(am__dirstamp)
algo/yespower2b/crypto/cpuminer-blake2b.$(OBJEXT):  \
	algo/yespower2b/crypto/$(am__dirstamp) \
	algo/yespower2b/crypto/$(DEPDIR)/$(am__dirstamp)
...
algo/yescrypt/cpuminer-yescrypt-best.$(OBJEXT):  \
	algo/yescrypt/$(am__dirstamp) \
	algo/yescrypt/$(DEPDIR)/$(am__dirstamp)
algo/neuromorph/$(am__dirstamp):
	@$(MKDIR_P) algo/neuromorph
	@: > algo/neuromorph/$(am__dirstamp)
algo/neuromorph/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) algo/neuromorph/$(DEPDIR)
	@: > algo/neuromorph/$(DEPDIR)/$(am__dirstamp)
algo/neuromorph/cpuminer-nm_params.$(OBJEXT):  \
	algo/neuromorph/$(am__dirstamp) \
	algo/neuromorph/$(DEPDIR)/$(am__dirstamp)
algo/neuromorph/cpuminer-nm_fast.$(OBJEXT):  \
	algo/neuromorph/$(am__dirstamp) \
	algo/neuromorph/$(DEPDIR)/$(am__dirstamp)
algo/neuromorph/cpuminer-neuromorph.$(OBJEXT):  \
	algo/neuromorph/$(am__dirstamp) \
	algo/neuromorph/$(DEPDIR)/$(am__dirstamp)
asm/$(am__dirstamp):
	@$(MKDIR_P) asm
...
mostlyclean-compile:
	...
	-rm -f algo/yespower2b/*.$(OBJEXT)
	-rm -f algo/yespower2b/crypto/*.$(OBJEXT)
	-rm -f asm/*.$(OBJEXT)
	-rm -f compat/*.$(OBJEXT)
	-rm -f crypto/*.$(OBJEXT)
...
include algo/$(DEPDIR)/cpuminer-m7m.Po # am--include-marker
...
include algo/argon2/argon2d/argon2d/$(DEPDIR)/cpuminer-thread.Po # am--include-marker
...
include algo/blake/$(DEPDIR)/cpuminer-blake-hash-4way.Po # am--include-marker
...
include algo/keccak/sse2/$(DEPDIR)/cpuminer-keccak.Po # am--include-marker
include algo/luffa/$(DEPDIR)/cpuminer-luffa-hash-2way.Po # am--include-marker
include algo/luffa/$(DEPDIR)/cpuminer-luffa.Po # am--include-marker
...
include algo/neoscrypt/$(DEPDIR)/cpuminer-neoscrypt.Po # am--include-marker
include algo/neuromorph/$(DEPDIR)/cpuminer-neuromorph.Po # am--include-marker
include algo/neuromorph/$(DEPDIR)/cpuminer-nm_fast.Po # am--include-marker
include algo/neuromorph/$(DEPDIR)/cpuminer-nm_params.Po # am--include-marker
...
include algo/scryptjane/$(DEPDIR)/cpuminer-scrypt-jane.Po # am--include-marker
include algo/sha/$(DEPDIR)/cpuminer-sha2-hash-4way.Po # am--include-marker
...
include algo/skein/$(DEPDIR)/cpuminer-skein2-gate.Po # am--include-marker
...
include algo/whirlpool/$(DEPDIR)/cpuminer-whirlpool-4way.Po # am--include-marker
...
include algo/yescrypt/$(DEPDIR)/cpuminer-sha256_Y.Po # am--include-marker
...
include algo/yespower/$(DEPDIR)/cpuminer-sha256-P.Po # am--include-marker
include algo/yespower/$(DEPDIR)/cpuminer-yespower-opt.Po # am--include-marker
include algo/yespower/$(DEPDIR)/cpuminer-yespower.Po # am--include-marker
include algo/yespower2b/$(DEPDIR)/cpuminer-yespower-miner.Po # am--include-marker
include algo/yespower2b/$(DEPDIR)/cpuminer-yespower.Po # am--include-marker
include algo/yespower2b/crypto/$(DEPDIR)/cpuminer-blake2b.Po # am--include-marker
...
include crypto/$(DEPDIR)/cpuminer-magimath.Po # am--include-marker
...
algo/argon2/argon2d/argon2d/cpuminer-thread.o: algo/argon2/argon2d/argon2d/thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/argon2/argon2d/argon2d/cpuminer-thread.o -MD -MP -MF algo/argon2/argon2d/argon2d/$(DEPDIR)/cpuminer-thread.Tpo -c -o algo/argon2/argon2d/argon2d/cpuminer-thread.o `test -f 'algo/argon2/argon2d/argon2d/thread.c' || echo '$(srcdir)/'`algo/argon2/argon2d/argon2d/thread.c
	$(AM_V_at)$(am__mv) algo/argon2/argon2d/argon2d/$(DEPDIR)/cpuminer-thread.Tpo algo/argon2/argon2d/argon2d/$(DEPDIR)/cpuminer-thread.Po
#	$(AM_V_CC)source='algo/argon2/argon2d/argon2d/thread.c' object='algo/argon2/argon2d/argon2d/cpuminer-thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/argon2/argon2d/argon2d/cpuminer-thread.o `test -f 'algo/argon2/argon2d/argon2d/thread.c' || echo '$(srcdir)/'`algo/argon2/argon2d/argon2d/thread.c

algo/argon2/argon2d/argon2d/cpuminer-thread.obj: algo/argon2/argon2d/argon2d/thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/argon2/argon2d/argon2d/cpuminer-thread.obj -MD -MP -MF algo/argon2/argon2d/argon2d/$(DEPDIR)/cpuminer-thread.Tpo -c -o algo/argon2/argon2d/argon2d/cpuminer-thread.obj `if test -f 'algo/argon2/argon2d/argon2d/thread.c'; then $(CYGPATH_W) 'algo/argon2/argon2d/argon2d/thread.c'; else $(CYGPATH_W) '$(srcdir)/algo/argon2/argon2d/argon2d/thread.c'; fi`
	$(AM_V_at)$(am__mv) algo/argon2/argon2d/argon2d/$(DEPDIR)/cpuminer-thread.Tpo algo/argon2/argon2d/argon2d/$(DEPDIR)/cpuminer-thread.Po
#	$(AM_V_CC)source='algo/argon2/argon2d/argon2d/thread.c' object='algo/argon2/argon2d/argon2d/cpuminer-thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/argon2/argon2d/argon2d/cpuminer-thread.obj `if test -f 'algo/argon2/argon2d/argon2d/thread.c'; then $(CYGPATH_W) 'algo/argon2/argon2d/argon2d/thread.c'; else $(CYGPATH_W) '$(srcdir)/algo/argon2/argon2d/argon2d/thread.c'; fi`
...
algo/blake/cpuminer-blake-hash-4way.o: algo/blake/blake-hash-4way.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/blake/cpuminer-blake-hash-4way.o -MD -MP -MF algo/blake/$(DEPDIR)/cpuminer-blake-hash-4way.Tpo -c -o algo/blake/cpuminer-blake-hash-4way.o `test -f 'algo/blake/blake-hash-4way.c' || echo '$(srcdir)/'`algo/blake/blake-hash-4way.c
	$(AM_V_at)$(am__mv) algo/blake/$(DEPDIR)/cpuminer-blake-hash-4way.Tpo algo/blake/$(DEPDIR)/cpuminer-blake-hash-4way.Po
#	$(AM_V_CC)source='algo/blake/blake-hash-4way.c' object='algo/blake/cpuminer-blake-hash-4way.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/blake/cpuminer-blake-hash-4way.o `test -f 'algo/blake/blake-hash-4way.c' || echo '$(srcdir)/'`algo/blake/blake-hash-4way.c

algo/blake/cpuminer-blake-hash-4way.obj: algo/blake/blake-hash-4way.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/blake/cpuminer-blake-hash-4way.obj -MD -MP -MF algo/blake/$(DEPDIR)/cpuminer-blake-hash-4way.Tpo -c -o algo/blake/cpuminer-blake-hash-4way.obj `if test -f 'algo/blake/blake-hash-4way.c'; then $(CYGPATH_W) 'algo/blake/blake-hash-4way.c'; else $(CYGPATH_W) '$(srcdir)/algo/blake/blake-hash-4way.c'; fi`
	$(AM_V_at)$(am__mv) algo/blake/$(DEPDIR)/cpuminer-blake-hash-4way.Tpo algo/blake/$(DEPDIR)/cpuminer-blake-hash-4way.Po
#	$(AM_V_CC)source='algo/blake/blake-hash-4way.c' object='algo/blake/cpuminer-blake-hash-4way.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/blake/cpuminer-blake-hash-4way.obj `if test -f 'algo/blake/blake-hash-4way.c'; then $(CYGPATH_W) 'algo/blake/blake-hash-4way.c'; else $(CYGPATH_W) '$(srcdir)/algo/blake/blake-hash-4way.c'; fi`
...
algo/bmw/cpuminer-bmw-hash-4way.o: algo/bmw/bmw-hash-4way.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/bmw/cpuminer-bmw-hash-4way.o -MD -MP -MF algo/bmw/$(DEPDIR)/cpuminer-bmw-hash-4way.Tpo -c -o algo/bmw/cpuminer-bmw-hash-4way.o `test -f 'algo/bmw/bmw-hash-4way.c' || echo '$(srcdir)/'`algo/bmw/bmw-hash-4way.c
	$(AM_V_at)$(am__mv) algo/bmw/$(DEPDIR)/cpuminer-bmw-hash-4way.Tpo algo/bmw/$(DEPDIR)/cpuminer-bmw-hash-4way.Po
#	$(AM_V_CC)source='algo/bmw/bmw-hash-4way.c' object='algo/bmw/cpuminer-bmw-hash-4way.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/bmw/cpuminer-bmw-hash-4way.o `test -f 'algo/bmw/bmw-hash-4way.c' || echo '$(srcdir)/'`algo/bmw/bmw-hash-4way.c

algo/bmw/cpuminer-bmw-hash-4way.obj: algo/bmw/bmw-hash-4way.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/bmw/cpuminer-bmw-hash-4way.obj -MD -MP -MF algo/bmw/$(DEPDIR)/cpuminer-bmw-hash-4way.Tpo -c -o algo/bmw/cpuminer-bmw-hash-4way.obj `if test -f 'algo/bmw/bmw-hash-4way.c'; then $(CYGPATH_W) 'algo/bmw/bmw-hash-4way.c'; else $(CYGPATH_W) '$(srcdir)/algo/bmw/bmw-hash-4way.c'; fi`
	$(AM_V_at)$(am__mv) algo/bmw/$(DEPDIR)/cpuminer-bmw-hash-4way.Tpo algo/bmw/$(DEPDIR)/cpuminer-bmw-hash-4way.Po
#	$(AM_V_CC)source='algo/bmw/bmw-hash-4way.c' object='algo/bmw/cpuminer-bmw-hash-4way.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/bmw/cpuminer-bmw-hash-4way.obj `if test -f 'algo/bmw/bmw-hash-4way.c'; then $(CYGPATH_W) 'algo/bmw/bmw-hash-4way.c'; else $(CYGPATH_W) '$(srcdir)/algo/bmw/bmw-hash-4way.c'; fi`
...
algo/neoscrypt/cpuminer-neoscrypt.o: algo/neoscrypt/neoscrypt.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/neoscrypt/cpuminer-neoscrypt.o -MD -MP -MF algo/neoscrypt/$(DEPDIR)/cpuminer-neoscrypt.Tpo -c -o algo/neoscrypt/cpuminer-neoscrypt.o `test -f 'algo/neoscrypt/neoscrypt.c' || echo '$(srcdir)/'`algo/neoscrypt/neoscrypt.c
	$(AM_V_at)$(am__mv) algo/neoscrypt/$(DEPDIR)/cpuminer-neoscrypt.Tpo algo/neoscrypt/$(DEPDIR)/cpuminer-neoscrypt.Po
#	$(AM_V_CC)source='algo/neoscrypt/neoscrypt.c' object='algo/neoscrypt/cpuminer-neoscrypt.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/neoscrypt/cpuminer-neoscrypt.o `test -f 'algo/neoscrypt/neoscrypt.c' || echo '$(srcdir)/'`algo/neoscrypt/neoscrypt.c

algo/neoscrypt/cpuminer-neoscrypt.obj: algo/neoscrypt/neoscrypt.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/neoscrypt/cpuminer-neoscrypt.obj -MD -MP -MF algo/neoscrypt/$(DEPDIR)/cpuminer-neoscrypt.Tpo -c -o algo/neoscrypt/cpuminer-neoscrypt.obj `if test -f 'algo/neoscrypt/neoscrypt.c'; then $(CYGPATH_W) 'algo/neoscrypt/neoscrypt.c'; else $(CYGPATH_W) '$(srcdir)/algo/neoscrypt/neoscrypt.c'; fi`
	$(AM_V_at)$(am__mv) algo/neoscrypt/$(DEPDIR)/cpuminer-neoscrypt.Tpo algo/neoscrypt/$(DEPDIR)/cpuminer-neoscrypt.Po
#	$(AM_V_CC)source='algo/neoscrypt/neoscrypt.c' object='algo/neoscrypt/cpuminer-neoscrypt.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/neoscrypt/cpuminer-neoscrypt.obj `if test -f 'algo/neoscrypt/neoscrypt.c'; then $(CYGPATH_W) 'algo/neoscrypt/neoscrypt.c'; else $(CYGPATH_W) '$(srcdir)/algo/neoscrypt/neoscrypt.c'; fi`
...
algo/sha/cpuminer-sha2-hash-4way.o: algo/sha/sha2-hash-4way.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/sha/cpuminer-sha2-hash-4way.o -MD -MP -MF algo/sha/$(DEPDIR)/cpuminer-sha2-hash-4way.Tpo -c -o algo/sha/cpuminer-sha2-hash-4way.o `test -f 'algo/sha/sha2-hash-4way.c' || echo '$(srcdir)/'`algo/sha/sha2-hash-4way.c
	$(AM_V_at)$(am__mv) algo/sha/$(DEPDIR)/cpuminer-sha2-hash-4way.Tpo algo/sha/$(DEPDIR)/cpuminer-sha2-hash-4way.Po
#	$(AM_V_CC)source='algo/sha/sha2-hash-4way.c' object='algo/sha/cpuminer-sha2-hash-4way.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/sha/cpuminer-sha2-hash-4way.o `test -f 'algo/sha/sha2-hash-4way.c' || echo '$(srcdir)/'`algo/sha/sha2-hash-4way.c

algo/sha/cpuminer-sha2-hash-4way.obj: algo/sha/sha2-hash-4way.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/sha/cpuminer-sha2-hash-4way.obj -MD -MP -MF algo/sha/$(DEPDIR)/cpuminer-sha2-hash-4way.Tpo -c -o algo/sha/cpuminer-sha2-hash-4way.obj `if test -f 'algo/sha/sha2-hash-4way.c'; then $(CYGPATH_W) 'algo/sha/sha2-hash-4way.c'; else $(CYGPATH_W) '$(srcdir)/algo/sha/sha2-hash-4way.c'; fi`
	$(AM_V_at)$(am__mv) algo/sha/$(DEPDIR)/cpuminer-sha2-hash-4way.Tpo algo/sha/$(DEPDIR)/cpuminer-sha2-hash-4way.Po
#	$(AM_V_CC)source='algo/sha/sha2-hash-4way.c' object='algo/sha/cpuminer-sha2-hash-4way.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/sha/cpuminer-sha2-hash-4way.obj `if test -f 'algo/sha/sha2-hash-4way.c'; then $(CYGPATH_W) 'algo/sha/sha2-hash-4way.c'; else $(CYGPATH_W) '$(srcdir)/algo/sha/sha2-hash-4way.c'; fi`
...
algo/skein/cpuminer-skein2-gate.o: algo/skein/skein2-gate.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/skein/cpuminer-skein2-gate.o -MD -MP -MF algo/skein/$(DEPDIR)/cpuminer-skein2-gate.Tpo -c -o algo/skein/cpuminer-skein2-gate.o `test -f 'algo/skein/skein2-gate.c' || echo '$(srcdir)/'`algo/skein/skein2-gate.c
	$(AM_V_at)$(am__mv) algo/skein/$(DEPDIR)/cpuminer-skein2-gate.Tpo algo/skein/$(DEPDIR)/cpuminer-skein2-gate.Po
#	$(AM_V_CC)source='algo/skein/skein2-gate.c' object='algo/skein/cpuminer-skein2-gate.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/skein/cpuminer-skein2-gate.o `test -f 'algo/skein/skein2-gate.c' || echo '$(srcdir)/'`algo/skein/skein2-gate.c

algo/skein/cpuminer-skein2-gate.obj: algo/skein/skein2-gate.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/skein/cpuminer-skein2-gate.obj -MD -MP -MF algo/skein/$(DEPDIR)/cpuminer-skein2-gate.Tpo -c -o algo/skein/cpuminer-skein2-gate.obj `if test -f 'algo/skein/skein2-gate.c'; then $(CYGPATH_W) 'algo/skein/skein2-gate.c'; else $(CYGPATH_W) '$(srcdir)/algo/skein/skein2-gate.c'; fi`
	$(AM_V_at)$(am__mv) algo/skein/$(DEPDIR)/cpuminer-skein2-gate.Tpo algo/skein/$(DEPDIR)/cpuminer-skein2-gate.Po
#	$(AM_V_CC)source='algo/skein/skein2-gate.c' object='algo/skein/cpuminer-skein2-gate.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/skein/cpuminer-skein2-gate.obj `if test -f 'algo/skein/skein2-gate.c'; then $(CYGPATH_W) 'algo/skein/skein2-gate.c'; else $(CYGPATH_W) '$(srcdir)/algo/skein/skein2-gate.c'; fi`
...
algo/whirlpool/cpuminer-whirlpool-4way.o: algo/whirlpool/whirlpool-4way.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/whirlpool/cpuminer-whirlpool-4way.o -MD -MP -MF algo/whirlpool/$(DEPDIR)/cpuminer-whirlpool-4way.Tpo -c -o algo/whirlpool/cpuminer-whirlpool-4way.o `test -f 'algo/whirlpool/whirlpool-4way.c' || echo '$(srcdir)/'`algo/whirlpool/whirlpool-4way.c
	$(AM_V_at)$(am__mv) algo/whirlpool/$(DEPDIR)/cpuminer-whirlpool-4way.Tpo algo/whirlpool/$(DEPDIR)/cpuminer-whirlpool-4way.Po
#	$(AM_V_CC)source='algo/whirlpool/whirlpool-4way.c' object='algo/whirlpool/cpuminer-whirlpool-4way.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/whirlpool/cpuminer-whirlpool-4way.o `test -f 'algo/whirlpool/whirlpool-4way.c' || echo '$(srcdir)/'`algo/whirlpool/whirlpool-4way.c

algo/whirlpool/cpuminer-whirlpool-4way.obj: algo/whirlpool/whirlpool-4way.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/whirlpool/cpuminer-whirlpool-4way.obj -MD -MP -MF algo/whirlpool/$(DEPDIR)/cpuminer-whirlpool-4way.Tpo -c -o algo/whirlpool/cpuminer-whirlpool-4way.obj `if test -f 'algo/whirlpool/whirlpool-4way.c'; then $(CYGPATH_W) 'algo/whirlpool/whirlpool-4way.c'; else $(CYGPATH_W) '$(srcdir)/algo/whirlpool/whirlpool-4way.c'; fi`
	$(AM_V_at)$(am__mv) algo/whirlpool/$(DEPDIR)/cpuminer-whirlpool-4way.Tpo algo/whirlpool/$(DEPDIR)/cpuminer-whirlpool-4way.Po
#	$(AM_V_CC)source='algo/whirlpool/whirlpool-4way.c' object='algo/whirlpool/cpuminer-whirlpool-4way.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/whirlpool/cpuminer-whirlpool-4way.obj `if test -f 'algo/whirlpool/whirlpool-4way.c'; then $(CYGPATH_W) 'algo/whirlpool/whirlpool-4way.c'; else $(CYGPATH_W) '$(srcdir)/algo/whirlpool/whirlpool-4way.c'; fi`
...
algo/yespower/cpuminer-yespower.o: algo/yespower/yespower.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/yespower/cpuminer-yespower.o -MD -MP -MF algo/yespower/$(DEPDIR)/cpuminer-yespower.Tpo -c -o algo/yespower/cpuminer-yespower.o `test -f 'algo/yespower/yespower.c' || echo '$(srcdir)/'`algo/yespower/yespower.c
	$(AM_V_at)$(am__mv) algo/yespower/$(DEPDIR)/cpuminer-yespower.Tpo algo/yespower/$(DEPDIR)/cpuminer-yespower.Po
#	$(AM_V_CC)source='algo/yespower/yespower.c' object='algo/yespower/cpuminer-yespower.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/yespower/cpuminer-yespower.o `test -f 'algo/yespower/yespower.c' || echo '$(srcdir)/'`algo/yespower/yespower.c

algo/yespower/cpuminer-yespower.obj: algo/yespower/yespower.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/yespower/cpuminer-yespower.obj -MD -MP -MF algo/yespower/$(DEPDIR)/cpuminer-yespower.Tpo -c -o algo/yespower/cpuminer-yespower.obj `if test -f 'algo/yespower/yespower.c'; then $(CYGPATH_W) 'algo/yespower/yespower.c'; else $(CYGPATH_W) '$(srcdir)/algo/yespower/yespower.c'; fi`
	$(AM_V_at)$(am__mv) algo/yespower/$(DEPDIR)/cpuminer-yespower.Tpo algo/yespower/$(DEPDIR)/cpuminer-yespower.Po
#	$(AM_V_CC)source='algo/yespower/yespower.c' object='algo/yespower/cpuminer-yespower.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/yespower/cpuminer-yespower.obj `if test -f 'algo/yespower/yespower.c'; then $(CYGPATH_W) 'algo/yespower/yespower.c'; else $(CYGPATH_W) '$(srcdir)/algo/yespower/yespower.c'; fi`

algo/yespower/cpuminer-sha256-P.o: algo/yespower/sha256-P.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/yespower/cpuminer-sha256-P.o -MD -MP -MF algo/yespower/$(DEPDIR)/cpuminer-sha256-P.Tpo -c -o algo/yespower/cpuminer-sha256-P.o `test -f 'algo/yespower/sha256-P.c' || echo '$(srcdir)/'`algo/yespower/sha256-P.c
	$(AM_V_at)$(am__mv) algo/yespower/$(DEPDIR)/cpuminer-sha256-P.Tpo algo/yespower/$(DEPDIR)/cpuminer-sha256-P.Po
#	$(AM_V_CC)source='algo/yespower/sha256-P.c' object='algo/yespower/cpuminer-sha256-P.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/yespower/cpuminer-sha256-P.o `test -f 'algo/yespower/sha256-P.c' || echo '$(srcdir)/'`algo/yespower/sha256-P.c

algo/yespower/cpuminer-sha256-P.obj: algo/yespower/sha256-P.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/yespower/cpuminer-sha256-P.obj -MD -MP -MF algo/yespower/$(DEPDIR)/cpuminer-sha256-P.Tpo -c -o algo/yespower/cpuminer-sha256-P.obj `if test -f 'algo/yespower/sha256-P.c'; then $(CYGPATH_W) 'algo/yespower/sha256-P.c'; else $(CYGPATH_W) '$(srcdir)/algo/yespower/sha256-P.c'; fi`
	$(AM_V_at)$(am__mv) algo/yespower/$(DEPDIR)/cpuminer-sha256-P.Tpo algo/yespower/$(DEPDIR)/cpuminer-sha256-P.Po
#	$(AM_V_CC)source='algo/yespower/sha256-P.c' object='algo/yespower/cpuminer-sha256-P.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/yespower/cpuminer-sha256-P.obj `if test -f 'algo/yespower/sha256-P.c'; then $(CYGPATH_W) 'algo/yespower/sha256-P.c'; else $(CYGPATH_W) '$(srcdir)/algo/yespower/sha256-P.c'; fi`
...
#	$(AM_V_CC)source='algo/yespower2b/yespower-miner.c' object='algo/yespower2b/cpuminer-yespower-miner.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/yespower2b/cpuminer-yespower-miner.o `test -f 'algo/yespower2b/yespower-miner.c' || echo '$(srcdir)/'`algo/yespower2b/yespower-miner.c

algo/yespower2b/cpuminer-yespower-miner.obj: algo/yespower2b/yespower-miner.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/yespower2b/cpuminer-yespower-miner.obj -MD -MP -MF algo/yespower2b/$(DEPDIR)/cpuminer-yespower-miner.Tpo -c -o algo/yespower2b/cpuminer-yespower-miner.obj `if test -f 'algo/yespower2b/yespower-miner.c'; then $(CYGPATH_W) 'algo/yespower2b/yespower-miner.c'; else $(CYGPATH_W) '$(srcdir)/algo/yespower2b/yespower-miner.c'; fi`
	$(AM_V_at)$(am__mv) algo/yespower2b/$(DEPDIR)/cpuminer-yespower-miner.Tpo algo/yespower2b/$(DEPDIR)/cpuminer-yespower-miner.Po
#	$(AM_V_CC)source='algo/yespower2b/yespower-miner.c' object='algo/yespower2b/cpuminer-yespower-miner.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/yespower2b/cpuminer-yespower-miner.obj `if test -f 'algo/yespower2b/yespower-miner.c'; then $(CYGPATH_W) 'algo/yespower2b/yespower-miner.c'; else $(CYGPATH_W) '$(srcdir)/algo/yespower2b/yespower-miner.c'; fi`

algo/yespower2b/crypto/cpuminer-blake2b.o: algo/yespower2b/crypto/blake2b.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/yespower2b/crypto/cpuminer-blake2b.o -MD -MP -MF algo/yespower2b/crypto/$(DEPDIR)/cpuminer-blake2b.Tpo -c -o algo/yespower2b/crypto/cpuminer-blake2b.o `test -f 'algo/yespower2b/crypto/blake2b.c' || echo '$(srcdir)/'`algo/yespower2b/crypto/blake2b.c
	$(AM_V_at)$(am__mv) algo/yespower2b/crypto/$(DEPDIR)/cpuminer-blake2b.Tpo algo/yespower2b/crypto/$(DEPDIR)/cpuminer-blake2b.Po
#	$(AM_V_CC)source='algo/yespower2b/crypto/blake2b.c' object='algo/yespower2b/crypto/cpuminer-blake2b.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/yespower2b/crypto/cpuminer-blake2b.o `test -f 'algo/yespower2b/crypto/blake2b.c' || echo '$(srcdir)/'`algo/yespower2b/crypto/blake2b.c

algo/yespower2b/crypto/cpuminer-blake2b.obj: algo/yespower2b/crypto/blake2b.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/yespower2b/crypto/cpuminer-blake2b.obj -MD -MP -MF algo/yespower2b/crypto/$(DEPDIR)/cpuminer-blake2b.Tpo -c -o algo/yespower2b/crypto/cpuminer-blake2b.obj `if test -f 'algo/yespower2b/crypto/blake2b.c'; then $(CYGPATH_W) 'algo/yespower2b/crypto/blake2b.c'; else $(CYGPATH_W) '$(srcdir)/algo/yespower2b/crypto/blake2b.c'; fi`
	$(AM_V_at)$(am__mv) algo/yespower2b/crypto/$(DEPDIR)/cpuminer-blake2b.Tpo algo/yespower2b/crypto/$(DEPDIR)/cpuminer-blake2b.Po
#	$(AM_V_CC)source='algo/yespower2b/crypto/blake2b.c' object='algo/yespower2b/crypto/cpuminer-blake2b.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/yespower2b/crypto/cpuminer-blake2b.obj `if test -f 'algo/yespower2b/crypto/blake2b.c'; then $(CYGPATH_W) 'algo/yespower2b/crypto/blake2b.c'; else $(CYGPATH_W) '$(srcdir)/algo/yespower2b/crypto/blake2b.c'; fi`

algo/yespower2b/cpuminer-yespower.o: algo/yespower2b/yespower.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/yespower2b/cpuminer-yespower.o -MD -MP -MF algo/yespower2b/$(DEPDIR)/cpuminer-yespower.Tpo -c -o algo/yespower2b/cpuminer-yespower.o `test -f 'algo/yespower2b/yespower.c' || echo '$(srcdir)/'`algo/yespower2b/yespower.c
	$(AM_V_at)$(am__mv) algo/yespower2b/$(DEPDIR)/cpuminer-yespower.Tpo algo/yespower2b/$(DEPDIR)/cpuminer-yespower.Po
#	$(AM_V_CC)source='algo/yespower2b/yespower.c' object='algo/yespower2b/cpuminer-yespower.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/yespower2b/cpuminer-yespower.o `test -f 'algo/yespower2b/yespower.c' || echo '$(srcdir)/'`algo/yespower2b/yespower.c

algo/yespower2b/cpuminer-yespower.obj: algo/yespower2b/yespower.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/yespower2b/cpuminer-yespower.obj -MD -MP -MF algo/yespower2b/$(DEPDIR)/cpuminer-yespower.Tpo -c -o algo/yespower2b/cpuminer-yespower.obj `if test -f 'algo/yespower2b/yespower.c'; then $(CYGPATH_W) 'algo/yespower2b/yespower.c'; else $(CYGPATH_W) '$(srcdir)/algo/yespower2b/yespower.c'; fi`
	$(AM_V_at)$(am__mv) algo/yespower2b/$(DEPDIR)/cpuminer-yespower.Tpo algo/yespower2b/$(DEPDIR)/cpuminer-yespower.Po
#	$(AM_V_CC)source='algo/yespower2b/yespower.c' object='algo/yespower2b/cpuminer-yespower.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/yespower2b/cpuminer-yespower.obj `if test -f 'algo/yespower2b/yespower.c'; then $(CYGPATH_W) 'algo/yespower2b/yespower.c'; else $(CYGPATH_W) '$(srcdir)/algo/yespower2b/yespower.c'; fi`
...
algo/neuromorph/cpuminer-nm_params.o: algo/neuromorph/nm_params.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/neuromorph/cpuminer-nm_params.o -MD -MP -MF algo/neuromorph/$(DEPDIR)/cpuminer-nm_params.Tpo -c -o algo/neuromorph/cpuminer-nm_params.o `test -f 'algo/neuromorph/nm_params.c' || echo '$(srcdir)/'`algo/neuromorph/nm_params.c
	$(AM_V_at)$(am__mv) algo/neuromorph/$(DEPDIR)/cpuminer-nm_params.Tpo algo/neuromorph/$(DEPDIR)/cpuminer-nm_params.Po
#	$(AM_V_CC)source='algo/neuromorph/nm_params.c' object='algo/neuromorph/cpuminer-nm_params.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/neuromorph/cpuminer-nm_params.o `test -f 'algo/neuromorph/nm_params.c' || echo '$(srcdir)/'`algo/neuromorph/nm_params.c

algo/neuromorph/cpuminer-nm_params.obj: algo/neuromorph/nm_params.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/neuromorph/cpuminer-nm_params.obj -MD -MP -MF algo/neuromorph/$(DEPDIR)/cpuminer-nm_params.Tpo -c -o algo/neuromorph/cpuminer-nm_params.obj `if test -f 'algo/neuromorph/nm_params.c'; then $(CYGPATH_W) 'algo/neuromorph/nm_params.c'; else $(CYGPATH_W) '$(srcdir)/algo/neuromorph/nm_params.c'; fi`
	$(AM_V_at)$(am__mv) algo/neuromorph/$(DEPDIR)/cpuminer-nm_params.Tpo algo/neuromorph/$(DEPDIR)/cpuminer-nm_params.Po
#	$(AM_V_CC)source='algo/neuromorph/nm_params.c' object='algo/neuromorph/cpuminer-nm_params.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/neuromorph/cpuminer-nm_params.obj `if test -f 'algo/neuromorph/nm_params.c'; then $(CYGPATH_W) 'algo/neuromorph/nm_params.c'; else $(CYGPATH_W) '$(srcdir)/algo/neuromorph/nm_params.c'; fi`

algo/neuromorph/cpuminer-nm_fast.o: algo/neuromorph/nm_fast.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/neuromorph/cpuminer-nm_fast.o -MD -MP -MF algo/neuromorph/$(DEPDIR)/cpuminer-nm_fast.Tpo -c -o algo/neuromorph/cpuminer-nm_fast.o `test -f 'algo/neuromorph/nm_fast.c' || echo '$(srcdir)/'`algo/neuromorph/nm_fast.c
	$(AM_V_at)$(am__mv) algo/neuromorph/$(DEPDIR)/cpuminer-nm_fast.Tpo algo/neuromorph/$(DEPDIR)/cpuminer-nm_fast.Po
#	$(AM_V_CC)source='algo/neuromorph/nm_fast.c' object='algo/neuromorph/cpuminer-nm_fast.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/neuromorph/cpuminer-nm_fast.o `test -f 'algo/neuromorph/nm_fast.c' || echo '$(srcdir)/'`algo/neuromorph/nm_fast.c

algo/neuromorph/cpuminer-nm_fast.obj: algo/neuromorph/nm_fast.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/neuromorph/cpuminer-nm_fast.obj -MD -MP -MF algo/neuromorph/$(DEPDIR)/cpuminer-nm_fast.Tpo -c -o algo/neuromorph/cpuminer-nm_fast.obj `if test -f 'algo/neuromorph/nm_fast.c'; then $(CYGPATH_W) 'algo/neuromorph/nm_fast.c'; else $(CYGPATH_W) '$(srcdir)/algo/neuromorph/nm_fast.c'; fi`
	$(AM_V_at)$(am__mv) algo/neuromorph/$(DEPDIR)/cpuminer-nm_fast.Tpo algo/neuromorph/$(DEPDIR)/cpuminer-nm_fast.Po
#	$(AM_V_CC)source='algo/neuromorph/nm_fast.c' object='algo/neuromorph/cpuminer-nm_fast.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/neuromorph/cpuminer-nm_fast.obj `if test -f 'algo/neuromorph/nm_fast.c'; then $(CYGPATH_W) 'algo/neuromorph/nm_fast.c'; else $(CYGPATH_W) '$(srcdir)/algo/neuromorph/nm_fast.c'; fi`

algo/neuromorph/cpuminer-neuromorph.o: algo/neuromorph/neuromorph.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/neuromorph/cpuminer-neuromorph.o -MD -MP -MF algo/neuromorph/$(DEPDIR)/cpuminer-neuromorph.Tpo -c -o algo/neuromorph/cpuminer-neuromorph.o `test -f 'algo/neuromorph/neuromorph.c' || echo '$(srcdir)/'`algo/neuromorph/neuromorph.c
	$(AM_V_at)$(am__mv) algo/neuromorph/$(DEPDIR)/cpuminer-neuromorph.Tpo algo/neuromorph/$(DEPDIR)/cpuminer-neuromorph.Po
#	$(AM_V_CC)source='algo/neuromorph/neuromorph.c' object='algo/neuromorph/cpuminer-neuromorph.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/neuromorph/cpuminer-neuromorph.o `test -f 'algo/neuromorph/neuromorph.c' || echo '$(srcdir)/'`algo/neuromorph/neuromorph.c

algo/neuromorph/cpuminer-neuromorph.obj: algo/neuromorph/neuromorph.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -MT algo/neuromorph/cpuminer-neuromorph.obj -MD -MP -MF algo/neuromorph/$(DEPDIR)/cpuminer-neuromorph.Tpo -c -o algo/neuromorph/cpuminer-neuromorph.obj `if test -f 'algo/neuromorph/neuromorph.c'; then $(CYGPATH_W) 'algo/neuromorph/neuromorph.c'; else $(CYGPATH_W) '$(srcdir)/algo/neuromorph/neuromorph.c'; fi`
	$(AM_V_at)$(am__mv) algo/neuromorph/$(DEPDIR)/cpuminer-neuromorph.Tpo algo/neuromorph/$(DEPDIR)/cpuminer-neuromorph.Po
#	$(AM_V_CC)source='algo/neuromorph/neuromorph.c' object='algo/neuromorph/cpuminer-neuromorph.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(cpuminer_CPPFLAGS) $(CPPFLAGS) $(cpuminer_CFLAGS) $(CFLAGS) -c -o algo/neuromorph/cpuminer-neuromorph.obj `if test -f 'algo/neuromorph/neuromorph.c'; then $(CYGPATH_W) 'algo/neuromorph/neuromorph.c'; else $(CYGPATH_W) '$(srcdir)/algo/neuromorph/neuromorph.c'; fi`
...
distclean-generic:
	...
	-rm -f algo/neuromorph/$(DEPDIR)/$(am__dirstamp)
	-rm -f algo/neuromorph/$(am__dirstamp)
	...
	-rm -f algo/yespower2b/$(DEPDIR)/$(am__dirstamp)
	-rm -f algo/yespower2b/$(am__dirstamp)
	-rm -f algo/yespower2b/crypto/$(DEPDIR)/$(am__dirstamp)
	-rm -f algo/yespower2b/crypto/$(am__dirstamp)
...
distclean: distclean-recursive
	...
	-rm -f algo/$(DEPDIR)/cpuminer-m7m.Po
	...
	-rm -f algo/argon2/argon2d/argon2d/$(DEPDIR)/cpuminer-thread.Po
	...
	-rm -f algo/blake/$(DEPDIR)/cpuminer-blake-hash-4way.Po
	...
	-rm -f algo/keccak/sse2/$(DEPDIR)/cpuminer-keccak.Po
	-rm -f algo/luffa/$(DEPDIR)/cpuminer-luffa-hash-2way.Po
	-rm -f algo/luffa/$(DEPDIR)/cpuminer-luffa.Po
	-rm -f algo/luffa/$(DEPDIR)/cpuminer-luffa_for_sse2.Po
	-rm -f algo/luffa/$(DEPDIR)/cpuminer-sph_luffa.Po
	-rm -f algo/neoscrypt/$(DEPDIR)/cpuminer-neoscrypt.Po
	-rm -f algo/neuromorph/$(DEPDIR)/cpuminer-neuromorph.Po
	-rm -f algo/neuromorph/$(DEPDIR)/cpuminer-nm_fast.Po
	-rm -f algo/neuromorph/$(DEPDIR)/cpuminer-nm_params.Po
	...
	-rm -f algo/scryptjane/$(DEPDIR)/cpuminer-scrypt-jane.Po
	-rm -f algo/sha/$(DEPDIR)/cpuminer-sha2-hash-4way.Po
	...
	-rm -f algo/skein/$(DEPDIR)/cpuminer-skein2-gate.Po
	...
	-rm -f algo/whirlpool/$(DEPDIR)/cpuminer-whirlpool-4way.Po
	...
	-rm -f algo/yescrypt/$(DEPDIR)/cpuminer-sha256_Y.Po
	-rm -f algo/yescrypt/$(DEPDIR)/cpuminer-yescrypt-best.Po
	-rm -f algo/yescrypt/$(DEPDIR)/cpuminer-yescrypt.Po
	-rm -f algo/yespower/$(DEPDIR)/cpuminer-sha256-P.Po
	-rm -f algo/yespower/$(DEPDIR)/cpuminer-yespower-opt.Po
	-rm -f algo/yespower/$(DEPDIR)/cpuminer-yespower.Po
	-rm -f algo/yespower2b/$(DEPDIR)/cpuminer-yespower-miner.Po
	-rm -f algo/yespower2b/$(DEPDIR)/cpuminer-yespower.Po
	-rm -f algo/yespower2b/crypto/$(DEPDIR)/cpuminer-blake2b.Po
	...
	-rm -f crypto/$(DEPDIR)/cpuminer-magimath.Po
